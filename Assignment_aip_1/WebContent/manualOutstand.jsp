...
<title>Outstanding order - Manual entry </title>
</head>
<body id ="oly_body">
   <div align="center">
        <table>
     ...
     <table id = "margin_fields">
       <tr>
         <td id = "label2">Enter Order No </td>
         <td>
         <form  method = "get" action= "<%=request.getContextPath()%>/DisplayManualOrder" >
